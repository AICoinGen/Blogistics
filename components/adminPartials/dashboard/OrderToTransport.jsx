        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <tbody className="text-sm  font-medium divide-y divide-slate-100">
              {orders_
                .filter((p) =>
                  type === "transported" ? p.transported === true : orders_
                )
                .map((order) => {
                  const object = {
...
export default OrderToTransport;
