      ...
      <div className="relative max-w-6xl mx-auto pt-12 px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-4  pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-2xl text-center">Policy Privacy</h2>

            <p>Welcome to Schain!</p>

            <h2>Privacy Policy</h2>
            <p>
              Your privacy is important to us. It is Schain&#39;s policy to
              ...
              <a href="https://schain.netlify.app/">
                https://schain.netlify.app/
              </a>
              , and other sites we own and operate.{" "}
            </p>
            <p>
              This policy is effective as of 15 May 2022 and was last updated on
              15 May 2022.{" "}
            </p>
